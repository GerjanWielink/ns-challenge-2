...
public class Program {
    ...
    private static final String SERVER_ADDRESS = "networkingchallenges.ewi.utwente.nl";
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // Create the client
            client = new DRDTChallengeClient(SERVER_ADDRESS, SERVER_PORT, GROUP_TOKEN);
